package com.sparta.spring_lv1.jwt;
...
public class JwtUtil {
    ...
    @PostConstruct  // 생성자가 만들어지고 생성자가 호출된 후에 이 객체가 생성된 다음에 init()코드가 실행된다.
    public void init() {
    ...
    public String createToken(String username, UserRoleEnum role) {
        ...
        return BEARER_PREFIX +
                Jwts.builder()
                        ...
                        .claim(AUTHORIZATION_KEY, role) // 사용자 권한 (key, value) 키 값은 위에서 선언한거, 값은 Enum 권한값
